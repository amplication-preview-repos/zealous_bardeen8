...
@InputType()
class DoctorCreateNestedManyWithoutDepartmentsInput {
...
export { DoctorCreateNestedManyWithoutDepartmentsInput as DoctorCreateNestedManyWithoutDepartmentsInput };
