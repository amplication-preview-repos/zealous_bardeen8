...
@InputType()
class DepartmentCreateNestedManyWithoutDoctorsInput {
...
export { DepartmentCreateNestedManyWithoutDoctorsInput as DepartmentCreateNestedManyWithoutDoctorsInput };
